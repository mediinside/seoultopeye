...
if($data_list_cnt > 0) {
	for ($i=0; $i<$data_list_cnt; $i++ ) {		
			...
			//타이틀이미지
			$new_image = " <img src=\"" . $GP -> IMGS_PATH . "/". $skin_dir . "/image/ticon_new.gif\" border='0' align='middle'>";
			$new_icon = $C_Func->new_icon(1, $data_list[$i]['jb_reg_date'], $new_image);
		
			//비밀글이미지
			$secret_icon = " <img src=\"" . $GP -> IMGS_PATH . "/". $skin_dir . "/image/ticon_key.gif\" border='0' align='middle'> ";	
