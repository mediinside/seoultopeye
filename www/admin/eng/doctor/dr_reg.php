<?php
	...
	$cn_select3 = $C_Func -> makeSelect_Normal('dr_branch', $GP -> ENG_BRANCH, $dr_center, '', '::선택::');		
	$cn_chk1 = $C_Func -> makeCheckbox_Normal($GP -> ENG_DOCTOR_POSITION, 'dr_position[]', $dr_position, '', '300');
?>
<body>
...
<script type="text/javascript">
	...
	$(document).ready(function(){	
		...
		$('#img_submit').click(function(){
				...
				if($('#dr_branch option:selected').val() == '') {
					alert('지점을 선택하세요');
					return false;
				}			
