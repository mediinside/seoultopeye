				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
								...
								<td >
										<input type="text" class="input_pop" size="15" name="pop_start_date" id="pop_start_date" value="<?=$pop_start_date?>" />
										 ~ 
										<input type="text" class="input_pop" size="15" name="pop_end_date" id="pop_end_date" value="<?=$pop_end_date?>" />
								</td>
						</tr>
						<tr>
								<th><span>*</span>크기</th>
								<td >
										가로 <input type="text" class="input_pop" size="15" name="pop_width" id="pop_width" value="<?=$pop_width?>" />px X 
										세로 <input type="text" class="input_pop" size="15" name="pop_height" id="pop_height" value="<?=$pop_height?>" />px
								</td>
						</tr>
						<tr>
								<th><span>*</span>위치</th>
								<td >
										LEFT <input type="text" class="input_pop" size="15" name="pop_x_position" id="pop_x_position" value="<?=$pop_x_position?>" />px X 
										TOP <input type="text" class="input_pop" size="15" name="pop_y_position" id="pop_y_position" value="<?=$pop_y_position?>" />px
								</td>
						</tr>
						<tr>
						...
						<tr id="TR3" style="display:none;">
								...
								<td>
									<input name="pop_link_url" id="pop_link_url" type="text" class="input_pop" value="<?=$pop_link_url?>" size="50" maxlength="200">
								</td>
						</tr>  
						<tr>
