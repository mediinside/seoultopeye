				...
				<table class="table table-bordered">
					<tbody>
						<tr>
							...
							<td width="85%">
								<input type="text" class="input_pop" size="25" name="pop_title" id="pop_title" value="<?=$pop_title?>" />
							</td>
						</tr>
						<tr>
							<th><span>*</span>형식</th>
						...
						<tr>
							...
							<td>
								<input type="text" class="input_pop" size="15" name="pop_start_date" id="pop_start_date" />
								 ~ 
								<input type="text" class="input_pop" size="15" name="pop_end_date" id="pop_end_date" />
							</td>
						</tr>
						<tr>
								<th><span>*</span>크기</th>
								<td>
										가로 <input type="text" class="input_pop" size="15" name="pop_width" id="pop_width" />px X 
										세로 <input type="text" class="input_pop" size="15" name="pop_height" id="pop_height" />px
								</td>
						</tr>
						<tr>
								<th><span>*</span>위치</th>
								<td>
										LEFT <input type="text" class="input_pop" size="15" name="pop_x_position" id="pop_x_position" />px X 
										TOP <input type="text" class="input_pop" size="15" name="pop_y_position" id="pop_y_position" />px
								</td>
						</tr>
						<tr>
								<th><span>*</span>스크롤사용여부</th>
								<td>
										<input type="radio" name="pop_scroll" value="Y" class="input_pop" />사용
										<input type="radio" name="pop_scroll" value="N" class="input_pop" checked="checked" />미사용
								</td>
						</tr>
						<tr id="TR1">
								<th><span>*</span>내용</th>
						...
						<tr id="TR2" style="display:none;">
								<th><span>*</span>이미지</th>
								<td>
									<input type="file" name="pop_file" id="pop_file" size="30" class="input_pop">
								</td>
						</tr>
						<tr id="TR3" style="display:none;">
								<th><span>*</span>클릭시 이동할 페이지</th>
								<td>
									<input name="pop_link_url" id="pop_link_url" type="text" class="input_pop" value="http://" size="50" maxlength="200">
								</td>
						</tr>  
						<tr>
