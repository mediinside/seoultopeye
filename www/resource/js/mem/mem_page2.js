	$(document).ready(function(){                              
			...
			$('#frmJoin').validate({
				rules: {
					...
					mb_pwd: { required: true, minlength: 4, maxlength:15, passch:true },
			...
			$('#frmPass').validate({
				rules: {				
					mb_pwd: { required: true, minlength: 4, maxlength:15 },
					mb_pwd_ch: { required: true, minlength: 4, maxlength:15 },
